...
import { ChevronLeft, Shirt, Calendar } from 'lucide-react';
import { d as Route$2 } from './router-h1SIfdX4.mjs';
import 'react';
...
function GuidePage() {
  ...
  if (!guide) {
    return /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-gray-50 dark:bg-gray-950 flex items-center justify-center", children: /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsx("p", { className: "text-gray-600 dark:text-gray-400", children: "Guide not found" }),
  ...
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-gray-50 dark:bg-gray-950 pb-20", children: /* @__PURE__ */ jsxs("div", { className: "max-w-2xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: `bg-gradient-to-br ${guide.gradient} p-8 flex flex-col items-center justify-center text-center min-h-[250px]`, children: [
      /* @__PURE__ */ jsx(Shirt, { className: "w-16 h-16 text-white/90 mb-4" }),
      /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold text-gray-900 dark:text-white mb-2", children: guide.title }),
      /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-700 dark:text-gray-200", children: guide.description })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "px-4 py-6 space-y-6", children: [
      /* @__PURE__ */ jsx("div", { className: "bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-800", children: /* @__PURE__ */ jsx("p", { className: "text-gray-700 dark:text-gray-300 leading-relaxed", children: guide.introduction }) }),
      guide.sections.map((section, idx) => /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-800", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-xl font-bold text-gray-800 dark:text-gray-100 mb-3", children: section.title }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-700 dark:text-gray-300 leading-relaxed mb-4", children: section.content }),
        section.tips && section.tips.length > 0 && /* @__PURE__ */ jsxs("div", { className: "bg-blue-50 dark:bg-blue-950/30 rounded-lg p-4 border border-blue-100 dark:border-blue-900", children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-blue-900 dark:text-blue-300 mb-2", children: "Pro Tips:" }),
          /* @__PURE__ */ jsx("ul", { className: "space-y-1", children: section.tips.map((tip, tipIdx) => /* @__PURE__ */ jsxs("li", { className: "text-sm text-blue-800 dark:text-blue-300 flex items-start gap-2", children: [
            /* @__PURE__ */ jsx("span", { className: "text-blue-500 dark:text-blue-400 mt-0.5", children: "\u2022" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex gap-3 pt-4", children: [
        /* @__PURE__ */ jsxs("button", { onClick: () => navigate({
          to: "/outfits/new"
        }), className: "flex-1 py-3 px-4 bg-blue-600 dark:bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 dark:hover:bg-blue-700 transition-colors flex items-center justify-center gap-2", children: [
          /* @__PURE__ */ jsx(Shirt, { className: "w-5 h-5" }),
          "Create Outfit"
        ] }),
        /* @__PURE__ */ jsxs("button", { onClick: () => navigate({
          to: "/calendar"
        }), className: "flex-1 py-3 px-4 bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg font-medium hover:bg-gray-300 dark:hover:bg-gray-700 transition-colors flex items-center justify-center gap-2", children: [
...
//# sourceMappingURL=_guideId-CmT51oUs.mjs.map
