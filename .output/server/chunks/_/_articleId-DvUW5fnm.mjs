...
import { e as Route$1 } from './router-h1SIfdX4.mjs';
import 'react';
...
const articlesData = {
  "color-coordination": {
    ...
    keyTakeaways: ["Start with neutrals and add one or two accent colors", "Use the color wheel to find complementary or analogous combinations", "Apply the 60-30-10 rule for balanced outfits", "Consider your skin tone when choosing colors", "Don't be afraid to experiment with unexpected combinations"]
  },
  "accessorize-pro": {
    ...
    keyTakeaways: ["Let one statement piece be the focal point", "Layer jewelry thoughtfully for dimension", "Match your bag to the occasion and outfit formality", "Scarves are versatile and add instant style", "Use belts to create shape and structure"]
  },
  "mix-match-patterns": {
    ...
    keyTakeaways: ["Keep colors consistent when mixing patterns", "Vary the scale of patterns for balance", "Use neutral solids as buffers between patterns", "Start with two patterns before adding more", "Let one pattern be the star of your outfit"]
  },
  "body-type-guide": {
    ...
    keyTakeaways: ["Body type guidelines are suggestions, not rules", "Focus on creating visual balance in your outfits", "Emphasize features you love instead of hiding others", "Proper fit is more important than following body type rules", "Confidence and comfort should guide your choices"]
  },
  "sustainable-fashion": {
    ...
    keyTakeaways: ["Buy fewer, higher-quality pieces that last longer", "Shop secondhand to reduce environmental impact", "Care for clothes properly to extend their life", "Choose sustainable and ethical brands when buying new", "Consider renting or swapping for special occasions"]
  },
  "confidence-style": {
    ...
    keyTakeaways: ["Your personal style should reflect your authentic self", "Use color psychology to boost confidence strategically", "Dress intentionally even for ordinary days", "Prioritize comfort\u2014it's essential for confidence", "Be patient and compassionate with yourself as you explore style"]
  }
};
function ArticlePage() {
  ...
  if (!article) {
    return /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-gray-50 dark:bg-gray-950 flex items-center justify-center", children: /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsx("p", { className: "text-gray-600 dark:text-gray-400", children: "Article not found" }),
      /* @__PURE__ */ jsx("button", { onClick: () => navigate({
        to: "/discover"
      }), className: "mt-4 text-blue-600 dark:text-blue-400 hover:underline", children: "Back to Discover" })
    ] }) });
  }
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-gray-50 dark:bg-gray-950 pb-20", children: /* @__PURE__ */ jsxs("div", { className: "max-w-2xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: `bg-gradient-to-br ${article.gradient} p-8 flex flex-col items-center justify-center text-center min-h-[250px]`, children: [
      /* @__PURE__ */ jsx(Sparkles, { className: "w-16 h-16 text-white/90 mb-4" }),
      /* @__PURE__ */ jsx("div", { className: "inline-block bg-white/20 dark:bg-black/20 px-3 py-1 rounded-full mb-3", children: /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-gray-900 dark:text-white", children: article.category }) }),
      /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold text-gray-900 dark:text-white mb-2", children: article.title })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "px-4 py-6 space-y-6", children: [
      /* @__PURE__ */ jsx("div", { className: "bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-800", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 mb-3", children: [
        /* @__PURE__ */ jsx(BookOpen, { className: "w-6 h-6 text-blue-600 dark:text-blue-400 flex-shrink-0 mt-1" }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h2", { className: "text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2", children: "Introduction" }),
          /* @__PURE__ */ jsx("p", { className: "text-gray-700 dark:text-gray-300 leading-relaxed", children: article.introduction })
        ] })
      ] }) }),
      article.mainContent.map((section, idx) => /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-800", children: [
        /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-gray-800 dark:text-gray-100 mb-3", children: section.subtitle }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-700 dark:text-gray-300 leading-relaxed", children: section.text })
      ] }, idx)),
      /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/50 dark:to-indigo-950/50 rounded-xl p-6 border border-blue-200 dark:border-blue-900", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
          /* @__PURE__ */ jsx(Lightbulb, { className: "w-6 h-6 text-blue-600 dark:text-blue-400" }),
          /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-gray-800 dark:text-gray-100", children: "Key Takeaways" })
        ] }),
        /* @__PURE__ */ jsx("ul", { className: "space-y-3", children: article.keyTakeaways.map((takeaway, idx) => /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-3", children: [
          /* @__PURE__ */ jsx("span", { className: "flex-shrink-0 w-6 h-6 bg-blue-600 dark:bg-blue-500 text-white rounded-full flex items-center justify-center text-sm font-bold", children: idx + 1 }),
          /* @__PURE__ */ jsx("span", { className: "text-gray-700 dark:text-gray-300 pt-0.5", children: takeaway })
        ] }, idx)) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-800 text-center", children: [
        /* @__PURE__ */ jsx("p", { className: "text-gray-700 dark:text-gray-300 mb-4", children: "Ready to put these tips into practice?" }),
        /* @__PURE__ */ jsx("button", { onClick: () => navigate({
          to: "/outfits/new"
        }), className: "py-3 px-6 bg-blue-600 dark:bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 dark:hover:bg-blue-700 transition-colors", children: "Create Your Outfit" })
      ] })
    ] })
  ] }) });
}
...
//# sourceMappingURL=_articleId-DvUW5fnm.mjs.map
