...
import { ChevronLeft, Sparkles, Shirt, X } from 'lucide-react';
import { useState, useEffect } from 'react';
import { u as useItems, g as useCreateOutfit } from './useData-Ya3GAmCM.mjs';
...
function CreateOutfitPage() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-gray-50 dark:bg-gray-950 pb-20", children: /* @__PURE__ */ jsxs("div", { className: "max-w-md mx-auto", children: [
    /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-4 py-4 sticky top-16 z-10", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsx("button", { onClick: handleSave, className: "px-4 py-2 bg-blue-600 dark:bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 dark:hover:bg-blue-700 transition-colors", children: "Save" })
      ] }),
      aiGenerated && /* @__PURE__ */ jsxs("div", { className: "mt-2 flex items-center gap-2 text-xs text-purple-600 dark:text-purple-400", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "px-4 py-6 space-y-6", children: [
      ...
      /* @__PURE__ */ jsxs("section", { className: "bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm border border-gray-200 dark:border-gray-800", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-4 gap-3 mb-6", children: items?.map((item) => /* @__PURE__ */ jsxs("button", { onClick: () => toggleItem(item.id), className: `flex flex-col items-center gap-2 p-3 rounded-xl border-2 transition-colors ${selectedItemIds.includes(item.id) ? "border-blue-500 dark:border-blue-600 bg-blue-50 dark:bg-blue-950" : "border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:border-gray-300 dark:hover:border-gray-600"}`, children: [
        ...
        selectedItems.length > 0 && /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-2", children: selectedItems.map((item) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700", children: [
            ...
            /* @__PURE__ */ jsx("button", { onClick: () => toggleItem(item.id), className: "p-1 hover:bg-gray-200 dark:hover:bg-gray-700 rounded transition-colors", children: /* @__PURE__ */ jsx(X, { className: "w-4 h-4 text-gray-600 dark:text-gray-400" }) })
          ] }, item.id)) })
        ] })
      ] })
    ] })
...
export { CreateOutfitPage as component };
//# sourceMappingURL=new-D7p17cBp.mjs.map
