...
import { ChevronLeft, Heart, Github, Mail, Star, Code } from 'lucide-react'
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="px-4 py-6 space-y-6">
          ...
          <div className="text-center py-8">
            <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-purple-600 rounded-3xl mx-auto mb-4 flex items-center justify-center shadow-lg">
          ...
          <section>
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 p-4">
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                Aura is a modern digital wardrobe management app that helps you organize your
                clothing, plan outfits, and track what you wear. All your data stays on your device
          ...
          <section>
            <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-4 text-center">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                © {buildDate} Aura Wardrobe. All rights reserved.
              </p>
