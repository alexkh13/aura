...
import { ChevronLeft, Key, Save, AlertCircle, Sparkles } from 'lucide-react'
          ...
          <div className="flex items-start gap-3 mb-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                Required: Add your Google AI API key to use Gemini AI for intelligent clothing analysis.
              </p>
          ...
          <div className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1 ml-2">
                ...
                <li>Flat-lay clothing photos</li>
                <li>Product shots</li>
                <li>Any clothing image</li>
              </ul>
            </div>
